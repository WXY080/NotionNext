const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://keliria0122.com' },
  ...
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'keliria.COM',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: 'NotionNext4.0 轻松定制主题',
  HERO_TITLE_LINK: 'https://keliria0122.com',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看战绩', url: '/tag/必看战绩' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: '实用教学', url: '/tag/实用教学' },
